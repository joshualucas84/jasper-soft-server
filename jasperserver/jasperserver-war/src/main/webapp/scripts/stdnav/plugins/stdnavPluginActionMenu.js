...
define(function (require, exports, module) {
    ...
    _.extend(stdnavPluginActionMenu.prototype, {
        ...
        _onFocusIn: function (element) {
            ...
            if ($selected.length>0) {
                var $thisItem = $selected.closest(layoutModule.NAVIGATION_PATTERN);
                if ($thisItem.length>0) {
                    ...
                    var $thisItem = $selected.closest(layoutModule.MENU_LIST_PATTERN);
                    if ($thisItem.length>0) {
    ...
    var newStdnavPluginActionMenu = new stdnavPluginActionMenu();
    return newStdnavPluginActionMenu;
});
